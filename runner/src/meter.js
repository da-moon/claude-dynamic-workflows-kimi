...
// Best-effort token estimation when the backend does not expose per-turn token
// counts (e.g. headless Kimi CLI). Counts 1 token per ~4 characters for ASCII
// text. This is intentionally rough and only used for budget guidance.
