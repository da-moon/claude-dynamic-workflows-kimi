...
export class KimiSessionDriver {
  ...
  _buildPrompt(prompt, schema, effort, { bare = false } = {}) {
    ...
    // Convey the requested reasoning effort as a natural-language hint (Kimi's
    // ladder is low | high | max; the CLI has no headless effort flag), applied
    // uniformly across models, exactly as kimiAgent.buildFullPrompt does.
